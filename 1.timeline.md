...
<div class="time-line">
    <ul class="timeline-split">
        ...
        <li class="timeline-item">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> <img src="{{ site.icons | relative_url }}/plane.png" class="marker"> Berlin, Germany / Reykjavik, Iceland</h4>
        ...
        <li class="timeline-item">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> <img src="{{ site.icons | relative_url }}/briefcase.png" class="marker"> Hongkong-Shenzhen, China</h4>
                <p>香港，怎么说呢，繁华，但总觉得有些扭曲，不知道是不是跟我的心情有关。MICCAI 2019, 更会开会了一些吧</p>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> <img src="{{ site.icons | relative_url }}/snowboard.png" class="marker"> Valmeinier, France</h4>
                <p>能感受到欣喜，就还在变得更好的路上。</p>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
