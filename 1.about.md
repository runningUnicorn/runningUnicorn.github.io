...
<div class="time-line">
    ...
    <ul class="timeline-split">
        ...
        <li class="timeline-item">
            <div class="timeline-info">
                <span>Aug., 2014</span><br>
                <span>Aug., 2016</span><br>
                <span>Oct., 2017</span><br>
                <span>March., 2018</span>
            </div>
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> &#x1F68C; Paris, France</h4>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
        ...
        <li class="timeline-item">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> &#x1F6B4; Amsterdam, Holland</h4>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> &#x1F699; Brussel, Belgien</h4>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> &#x1F699; Milan-Roma, Italy</h4>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> &#x1F6B4; Zürich-Luzern-Interlaken-Bern, Switzerland</h4>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
                <span>Dec., 2015</span><br>
                <span>March., 2017</span><br>
                <span>Oct., 2017</span>
            </div>
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> &#x1F6B4; Berlin, Germany</h4>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> &#x1F6B4; Reykjavik, Iceland</h4>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> &#x1F6B4; Monaco-Ville / Nice-Marseilles-Avignon-Arles, France</h4>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> &#x1F6B4; Bordeaux, France</h4>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> Copenhagen, Denmark / Gdansk-Warsaw-Krakow, Poland / Prague, Czech / Vienna-Hallstatt, Austria</h4>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title">Hague, Netherlands</h4>
            </div>
        </li>
        <li class="timeline-item period">
            <div class="timeline-info"></div>
        ...
        <li class="timeline-item">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title">St. Peterburg-Moscow-Simferopol-Sevastopol-Yalta-Sochi, Russia</h4>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> <img src="{{ site.images | relative_url }}/backpack.svg" class="marker"> Granada, Spain</h4>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h4 class="timeline-title"> &#x26F7; Salzburg-Flachau-Hochkönig, Austria</h4>
            </div>
        </li>
		<li class="timeline-item">
            <div class="timeline-info">
