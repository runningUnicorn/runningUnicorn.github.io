    ...
    <ul class="timeline-split">
		...
		<li class="timeline-item">
            ...
            <div class="timeline-content">
                ...
                <p>第一次坐在诺坎普的看台，竟然如此平静，可能朝圣的感觉超过了足球的狂热。第一次一个人旅行，游荡在里斯本的大街小巷，也是很有滋味。</p>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
        ...
        <li class="timeline-item">
            ...
            <div class="timeline-content">
                ...
                <p>作为专业底接，陪着大学同学，第一次打了真枪，游玩了柏林。</p>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
        ...
        <li class="timeline-item">
            ...
            <div class="timeline-content">
                ...
                <p>Escher可是就是理工科学生们最喜欢的“理性浪漫吧”。</p>
                <img src="{{ site.images | relative_url }}/escher.png" alt="flower" class='timeline-image'>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
