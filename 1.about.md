...
<div class="time-line">
    ...
    <ul class="timeline-split">
		...
		<li class="timeline-item">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h5 class="timeline-title">Barcelona, Madriad, Spain</h5>
				<h5 class="timeline-title">Lissabon, Portugal</h5>
            </div>
        </li>
        <li class="timeline-item">
            <div class="timeline-info">
            ...
            <div class="timeline-content">
				...
				<p>没有什么会难到超出你的认知，没有简单到应当嗤之以鼻。 Keep open and keep critic, ideas make fun, technologies play cool.</p>
            </div>
        </li>
        <li class="timeline-item period">
            <div class="timeline-info"></div>
		...
		<li class="timeline-item">
            ...
            <div class="timeline-marker"></div>
            <div class="timeline-content">
                <h3 class="timeline-title">Hintertux, Austria</h3>
